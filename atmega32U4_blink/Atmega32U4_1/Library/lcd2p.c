...
#define DDR_DATA_MASK ((1 << LCD02P_DB4) | (1 << LCD02P_DB5) | (1 << LCD02P_DB6) | (1 << LCD02P_DB7))
...
{
	// LCD INIC
	*lcd02pcmd_DDR |= ((1 << LCD02P_RS) | (1 << LCD02P_RW) | (1 << LCD02P_EN));
